          ...
          >
            ...
            <div className="flex justify-end">
              <button
                ...
                className="bg-red-500 text-white py-1 px-2 rounded-lg mt-2 hover:bg-red-700"
              >
                Delete
              </button>
            </div>
